...
cd catkin_ws/src
git clone https://github.com/Nick-AhSen/panda_simulation.git
git clone https://github.com/Nick-AhSen/panda_moveit_config.git
git clone --branch simulation https://github.com/Nick-AhSen/franka_ros.git
cd ..
